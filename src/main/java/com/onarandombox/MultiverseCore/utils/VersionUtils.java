...
public class VersionUtils {
    ...
    private static final Set<BukkitVersion> supportedVersions = ImmutableSet.of(v1_13_2_R01, v1_14_4_R01, v1_15_2_R01, v1_16_3_R01);

    private static BukkitVersion serverVersion;
    private static BukkitVersion testServerVersion = BukkitVersion.fromString("1.16.3-R0.1-SNAPSHOT");
    ...
    public static Set<BukkitVersion> getSupportedVersions() {
    ...
    public static class BukkitVersion implements Comparable<BukkitVersion> {
        ...
        public static BukkitVersion fromString(String string) {
            if (string == null) {
                throw new IllegalArgumentException("Bukkit version string cannot be null!");
            }
